...
import * as M7A from './routes/m7a.js?v=route-restore-v1';
import * as THEATER from './routes/theater.js?v=route-restore-v1';
import * as LIBRARY from './routes/library.js?v=route-restore-v1';
