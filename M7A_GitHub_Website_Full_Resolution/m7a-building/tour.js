...
import { createDirectory, searchHalls, localized } from './campus-directory.js?v=route-restore-v1';
import { findPath } from './directions.js';
import { PANORAMA_FILES, VISUAL_CALIBRATION, LOCATIONS, LOCATION_AR, getHotspotStyle } from './tour-routes.js?v=route-restore-v1';
